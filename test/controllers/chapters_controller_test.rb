...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { name: @chapter.name, poem_id: @chapter.poem_id } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { name: @chapter.name, poem_id: @chapter.poem_id } }
