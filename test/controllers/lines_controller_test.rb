...
class LinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post lines_url, params: { line: { name: @line.name, parent_id: @line.parent_id, parent_type: @line.parent_type } }
    end
  ...
  test "should update line" do
    patch line_url(@line), params: { line: { name: @line.name, parent_id: @line.parent_id, parent_type: @line.parent_type } }
